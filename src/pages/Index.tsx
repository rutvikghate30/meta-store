  ...
  return (
    <Layout>
      ...
      <section className="relative overflow-hidden pb-16 pt-24 md:pt-32 md:pb-24 bg-gradient-to-b from-background to-secondary/40">
        <div className="container-tight relative z-10">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
            <div className="mb-8 inline-block">
              <span className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none bg-primary/10 text-primary border-primary/20">
                New Collection
              </span>
            </div>
            
            <h1 className="text-4xl md:text-6xl font-medium tracking-tight mb-6 max-w-2xl animate-fade-in bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
        ...
        {/* Background Gradient */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-primary/5 blur-3xl opacity-50 animate-pulse-soft" />
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-secondary/30 to-secondary/10">
        <div className="container-tight">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10">
            <div>
              <h2 className="text-2xl md:text-3xl font-medium bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
                Top Products
              </h2>
              <p className="text-muted-foreground mt-2">Our highest rated items</p>
            </div>
            <Link to="/products" className="group inline-flex items-center mt-4 md:mt-0 text-sm font-medium text-primary hover:text-primary/80 transition-colors">
              View All
        ...
        <div className="container-tight">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl md:text-4xl font-medium mb-6 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
            ...
            <div className="order-1 lg:order-2">
              <div className="relative aspect-square overflow-hidden rounded-lg bg-primary/5 shadow-elegant">
                <img 
      ...
      <section className="py-16 bg-gradient-to-r from-secondary/30 to-secondary/10">
        <div className="container-tight">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-medium mb-4 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
              Why Choose Us
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 rounded-lg bg-background shadow-sm border border-primary/10 hover:shadow-elegant transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-lg font-medium mb-2 text-primary">Sustainable Materials</h3>
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-lg bg-background shadow-sm border border-primary/10 hover:shadow-elegant transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-lg font-medium mb-2 text-primary">Premium Craftsmanship</h3>
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-lg bg-background shadow-sm border border-primary/10 hover:shadow-elegant transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-lg font-medium mb-2 text-primary">Intuitive Design</h3>
